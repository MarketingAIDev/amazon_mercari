...
class ProductController extends Controller
{
	...
	public function etc_function()
	{
		...
		// $mercari_update = MercariUpdate::where('user_id', Auth::id())->where('product_status', '!=', 3)->orderBy('id', 'asc')->get();
		...
		$mercari_updates_limit = MercariUpdate::where('user_id', Auth::id())->where('SKU1_current_inventory', '=', 0)->orderBy('id', 'desc')->paginate(10);
		return view('components.etc_function', ['mercari_updates_limit' => $mercari_updates_limit]);
	}
}
